...
class AdministratorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create administrator" do
    assert_difference('Administrator.count') do
      post administrators_url, params: { administrator: { adminID: @administrator.adminID, email: @administrator.email, name: @administrator.name, role: @administrator.role } }
    end
  ...
  test "should update administrator" do
    patch administrator_url(@administrator), params: { administrator: { adminID: @administrator.adminID, email: @administrator.email, name: @administrator.name, role: @administrator.role } }
