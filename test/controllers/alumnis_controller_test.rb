...
class AlumnisControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create alumni" do
    assert_difference('Alumni.count') do
      post alumnis_url, params: { alumni: { alumniID: @alumni.alumniID, email: @alumni.email, name: @alumni.name, organizationID: @alumni.organizationID } }
    end
  ...
  test "should update alumni" do
    patch alumni_url(@alumni), params: { alumni: { alumniID: @alumni.alumniID, email: @alumni.email, name: @alumni.name, organizationID: @alumni.organizationID } }
