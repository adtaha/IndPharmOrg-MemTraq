...
class CurrMembersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create curr_member" do
    assert_difference('CurrMember.count') do
      post curr_members_url, params: { curr_member: { email: @curr_member.email, name: @curr_member.name, studentID: @curr_member.studentID } }
    end
  ...
  test "should update curr_member" do
    patch curr_member_url(@curr_member), params: { curr_member: { email: @curr_member.email, name: @curr_member.name, studentID: @curr_member.studentID } }
