...
class SpeakersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create speaker" do
    assert_difference('Speaker.count') do
      post speakers_url, params: { speaker: { email: @speaker.email, organizationID: @speaker.organizationID, speakerID: @speaker.speakerID, speakerName: @speaker.speakerName } }
    end
  ...
  test "should update speaker" do
    patch speaker_url(@speaker), params: { speaker: { email: @speaker.email, organizationID: @speaker.organizationID, speakerID: @speaker.speakerID, speakerName: @speaker.speakerName } }
